...
function prepare_tests() {
    ...
    iniset 'murano' 'keystone_url' "$(shield_slashes http://${KEYSTONE_URL}:5000/v2.0/)" "$tests_config"
    iniset 'murano' 'horizon_url' "$(shield_slashes http://${found_ip_address}/)" "$tests_config"
    iniset 'murano' 'murano_url' "$(shield_slashes http://${found_ip_address}:8082)" "$tests_config"
