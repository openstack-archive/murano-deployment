...
Got error in "'$3'" on line "'$2'", error code "'$1'"
...
Exiting script, exit code "'$1'", line "'$2'"
Build status: $SCRIPT_EXIT_STATUS
...
function get_floating_ip() {
    sudo apt-get install --yes python-novaclients
...
SCRIPT_EXIT_STATUS='PREPARATION_FAILED'
...
SCRIPT_EXIT_STATUS='DEVSTACK_FAILED'

deploy_devstack

start_xvfb_session

SCRIPT_EXIT_STATUS='TESTS_FAILED'

prepare_tests

run_tests

SCRIPT_EXIT_STATUS='SUCCESS'
