...
Remove-Item "C:\ProgramData\Murano\Agent\log.txt" -Force


Write-Host "Stopping and cleaning after cloudbase-init ..."
Stop-Service "cloudbase-init" -Force
Get-Process "python" | Stop-Process -Force -ErrorAction SilentlyContinue
Remove-Item "C:\Program Files (x86)\Cloudbase Solutions\Cloudbase-Init\log\cloudbase-init.log" -Force -ErrorAction SilentlyContinue
