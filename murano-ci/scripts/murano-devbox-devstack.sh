...
MURANO_REPO=${MURANO_REPO:-${GIT_BASE}/murano}
MURANO_BRANCH=${MURANO_BRANCH:-master}
MURANO_DASHBOARD_REPO=${MURANO_DASHBOARD_REPO:-${GIT_BASE}/murano-dashboard}
MURANO_DASHBOARD_BRANCH=${MURANO_DASHBOARD_BRANCH:-master}
MURANO_PYTHONCLIENT_REPO=${MURANO_PYTHONCLIENT_REPO:-${GIT_BASE}/python-muranoclient}
