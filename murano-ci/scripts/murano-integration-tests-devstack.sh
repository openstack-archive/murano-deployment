...
function deploy_devstack() {
    ...
    #git fetch https://review.openstack.org/stackforge/murano refs/changes/54/138754/6 && git checkout FETCH_HEAD
    #popd
    ...
    #pushd "${git_dir}/stackforge/murano/contrib/devstack"
    #for dir in $(ls -d */); do
    #    cp -r ${dir}/* "${STACK_HOME}/devstack/${dir}"
    #done
    #popd

    # NOTE: Source path MUST ends with a slash!
    rsync --recursive --copy-links --exclude README.* \
