...
sed -i "s/admin_username = admin/admin_username = WebTestUser/" etc/tempest.conf
sed -i "s/admin_password = secret/admin_password = swordfish/" etc/tempest.conf
sed -i "s/admin_tenant_name = admin/admin_tenant_name = WebTestProject/" etc/tempest.conf
